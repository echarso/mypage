...
var str;
if (element.indexOf("touristMainCountries") > -1 ) str =  "touristMainCountries.csv";
...
*/
  ...
  d3.csv(str, function(d, i, columns) {
    ...
    x0.domain(data.map(function(d) { return d.Origin_Country; }));
    ...
    g.append("g")
      ...
      .data(data)
      .enter().append("g")
        .attr("transform", function(d) { return "translate(" + x0(d.Origin_Country) + ",0)"; })
      .selectAll("rect")
