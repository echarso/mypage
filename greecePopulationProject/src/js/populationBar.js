...
if ( element) drawBar("#svg1");

var elementKrhth = document.getElementById("krhth");
if ( elementKrhth ) drawBar("#krhth");

var elementAgKor = document.getElementById("agoriaKoritsiaGreece")
if( elementAgKor ) drawBar("#agoriaKoritsiaGreece");

var elementAg = document.getElementById("tzovenoi")
if( elementAg ) drawBar("#tzovenoi");

var elementKor = document.getElementById("kopelies")
if( elementKor ) drawBar("#kopelies");
...
console.log(" bar chart is running " + element);
      ...
      .enter().append("rect")
		...
		.on("mouseover", function(d) {
		         ...
		         d3.selectAll(".barClass")
		           ...
		           .attr("fill",function(d){if( dInput == d){return "orangered"  ;}return z(d.key);});

       })
     .on("mouseout", function(d) {
       	div.transition().duration(500).style("opacity", 0);
       	d3.selectAll(".barClass").attr("fill",function(d){return z(d.key);});
       });
